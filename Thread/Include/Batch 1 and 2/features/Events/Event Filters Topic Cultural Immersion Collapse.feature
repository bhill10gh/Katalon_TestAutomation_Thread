...
@tag
Feature: Event Filters Topic Cultural Immersion Collapse
  I want to use this template for my feature file

  @tag1
  Scenario Outline: Event Filters Topic Cultural Immersion Collapse
    Given Cultural Immersion Collapse I am viewing the Events Page <url>
