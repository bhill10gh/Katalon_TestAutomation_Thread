...
class ContactUsSuccess {
	 ...
	 */
	@Given("Open Browser Goto Contact Us Page (.*) for Contact Us Success")
	...
	def FillAllFields() {
		...
		WebUI.setText(findTestObject('Object Repository/Page_Search  Thread Travel/Contact Us/Page_Contact Us  Thread Travel/input_Email Address_fxbd1be240f-bef2-4b4a-9_25b8f7'), 'test@test.com')
	...
	def OnContactUsReplyPage() {
		WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Search  Thread Travel/Contact Us/Page_Contact Us  Thread Travel/p_Thank you for contacting us Well get back to you shortly'), 0)
		WebUI.verifyElementPresent( findTestObject('Object Repository/Page_Search  Thread Travel/Contact Us/Page_Contact Us  Thread Travel/h1_Contact Us')   ,0)
		WebUI.closeBrowser()
	}
}