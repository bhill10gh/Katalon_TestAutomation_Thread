...
/**
	 ...
	 */
	@Given("Open browser and goto url: (.*) for Logout Successfully")
	...
	@And("Enter Username as (.*) and Password as (.*) for Logout Successfully")
	...
	def ClickLogoutButton() {
		...
		WebUI.scrollToElement(findTestObject('Page_Home  Thread Travel/a_Log out'), 100)

		WebUI.click(findTestObject('Object Repository/Page_Home  Thread Travel/a_Log out'))
	}
	
	@Then("Verify Login link is in upper right for Logout Successfully")
	def VerifyLogoutLink() {		
		
		WebUI.verifyElementText(findTestObject('Object Repository/Page_Home  Thread Travel/a_Login'), 'Login')
