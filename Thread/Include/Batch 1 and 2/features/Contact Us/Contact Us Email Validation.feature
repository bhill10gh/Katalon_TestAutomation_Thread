...
Feature: Contact Us Email Validation
  Test contact us validation for all input

  Scenario Outline: Contact Us Email Validation
    Given Open Browser Goto Contact Us Page <url> for Contact Us Email Validation
