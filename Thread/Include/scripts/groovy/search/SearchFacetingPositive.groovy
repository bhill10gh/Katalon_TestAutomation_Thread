...
class SearchFacetingPositive {
	/**
	 * The step definitions below match with Katalon sample Gherkin steps
	 */
	@Given("Open Browser Goto Search Page (.*) for Search Faceting – Positive")
	...
	def ClickCulturalImmersion() {
		WebUI.click(findTestObject('Object Repository/Page_Search  Thread Travel/input_Clear_Cultural Immersion'))
	}
